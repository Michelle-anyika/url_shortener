...
from api.views import (
    UserRegisterView, ThrottledTokenObtainPairView, LogoutView, SocialAuthView,
    URLCreateView, URLListView, URLDetailView, URLAnalyticsView,
)
...
urlpatterns = [
    ...
    # URL management — versioned at /api/v1/
